  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="bg-[#FFFFFF] border border-[#E4E1D8] rounded-xl p-6 sm:p-8 space-y-4 shadow-sm">
        <div className="flex items-center gap-3 border-b border-[#E4E1D8] pb-4">
        ...
        <div className="space-y-4 pt-2">
          <h3 className="font-serif font-semibold text-sm text-[#1C1B19]">How to Load Unpacked in Chrome / Edge / Brave:</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-xs">
            ...
            <div className="p-4 bg-[#FAFAF8] border border-[#E4E1D8] rounded-lg space-y-2">
              ...
              <h4 className="font-semibold text-[#1C1B19]">Enable Developer Mode</h4>
              <p className="text-[#6B6A63] text-[11px] leading-relaxed">
            ...
            <div className="p-4 bg-[#FAFAF8] border border-[#E4E1D8] rounded-lg space-y-2">
              ...
              <h4 className="font-semibold text-[#1C1B19]">Load Unpacked Directory</h4>
              <p className="text-[#6B6A63] text-[11px] leading-relaxed">
                Click <strong>Load unpacked</strong> and select the <code className="bg-[#E4E1D8] px-1 py-0.5 rounded text-[10px]">/extension</code> folder in this project!
              </p>
            </div>
          </div>
        </div>
